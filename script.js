document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      faq_a1:
        "We ship worldwide. Shipping costs will apply, and will be added at checkout.",
      ...
      faq_a3:
        "We aim to make sure our customers love our products, but if you do need to return an order, we’re happy to help. Just email us within 14 days of receiving your order and we’ll take you through the process. Please note that vintage items must be returned in the same condition they were received.",
      ...
      terms_3_text:
        "Your submission of personal information through the store is governed by our Privacy Policy. We do not sell or share your personal data with third parties for marketing purposes.",
      ...
      terms_5_text:
        "Questions about the Terms of Service should be sent to us at support@analogsoul.com.",
      // Auth
      auth_login: "Login",
    ...
    zh: {
      ...
      faq_q2: "收到訂單需要多久？",
      faq_a2:
        "這取決於您所在的地區。本地訂單約需 5-7 個工作天，海外運送約需 7-16 天。詳細資訊將包含在確認郵件中。",
      faq_orders_title: "訂單與退貨",
      faq_q3: "我可以退貨嗎？",
      faq_a3:
        "我們致力於確保客戶喜愛我們的產品。若您需要退貨，請在收到訂單後 14 天內透過電子郵件聯繫我們，我們將協助您處理。請注意，復古商品必須保持原狀退回。",
      faq_q4: "接受哪些付款方式？",
      ...
      terms_1_title: "1. 總覽",
      terms_1_text:
        "本網站由 Analog Soul 營運。在整個網站中，「我們」和「我們的」均指 Analog Soul。Analog Soul 向您（使用者）提供本網站，包括本網站提供的所有資訊、工具和服務，前提是您接受此處所述的所有條款、條件、政策和聲明。",
      terms_2_title: "2. 一般條款",
      terms_2_text:
        "我們保留隨時以任何理由拒絕向任何人提供服務的權利。您了解您的內容（不包括信用卡資訊）可能會在未加密的情況下傳輸，並涉及 (a) 透過各種網路傳輸；以及 (b) 為了符合和適應連接網路或裝置的技術要求而進行的變更。",
      terms_3_title: "3. 隱私政策",
      terms_3_text:
        "您透過商店提交的個人資訊受我們的隱私政策管轄。我們不會將您的個人數據出售或分享給第三方用於行銷目的。",
      terms_4_title: "4. 服務與價格修改",
      terms_4_text:
        "我們產品的價格如有變更，恕不另行通知。我們保留隨時修改或終止服務（或其任何部分或內容 thereof）的權利，恕不另行通知。",
  ...
  const productsData = {
    ...
    Country: [
      ...
      },
      {
        ...
        description:
          "Zach Bryan’s American Heartbreak marks his highly anticipated major-label debut, now available as a beautifully crafted vinyl LP. Known for his raw storytelling and emotional honesty, Bryan delivers a deeply personal collection that reflects the struggles, hopes, and everyday experiences of life in America. Written from the perspective of a 26-year-old navigating love, loss, and self-discovery, the album resonates with listeners through its heartfelt lyrics.",
        description_zh:
          "Zach Bryan 的《American Heartbreak》標誌著他備受期待的主要廠牌首秀，現已推出製作精美的黑膠唱片。Bryan 以其原始的故事敘述和情感誠實而聞名，帶來了一個深刻的個人合集，反映了在美國生活的掙扎、希望和日常經歷。這張專輯以一位 26 歲年輕人的視角寫成，講述了愛、失落和自我發現，透過其真摯的歌詞與聽眾產生共鳴。",
      },
      {
        title: "Jolene Vinyl",
        artist: "Dolly Parton",
        ...
        description:
          'Dolly Parton\'s iconic album "Jolene," now reissued on vinyl, captures the essence of her storytelling prowess and musical ingenuity. Released in 1974, the album features the profoundly evocative title track "Jolene," a song that not only topped the country charts but also made significant inroads into the pop and international markets. The song\'s narrative remains one of Parton\'s most beloved hits.',
        description_zh:
          "Dolly Parton 的標誌性專輯《Jolene》現已重新發行黑膠版本，捕捉了她故事敘述造詣和音樂獨創性的精髓。這張專輯於 1974 年發行，收錄了極具感染力的主打歌《Jolene》，這首歌不僅登上了鄉村音樂排行榜榜首，還打入了流行音樂和國際市場。這首歌的敘事仍然是 Parton 最受喜愛的熱門歌曲之一。",
      },
      {
        title:
          "Metamodern Sounds In Country Music (10th Anniversary Edition) Vinyl",
        ...
        description_zh:
          "限量 180 克黑膠壓製。十週年紀念版。《Metamodern Sounds in Country Music》是 Sturgill Simpson 的第二張錄音室專輯。標題是對 Ray Charles 專輯《Modern Sounds in Country and Western Music》的致敬，也引用了元現代主義的哲學和文化美學。",
      },
      {
    ...
    Rock: [
      ...
      },
      {
        ...
        description_zh:
          "藉由這張由 James Guthrie 重新修復的 180 克黑膠唱片，慶祝 Pink Floyd 傳奇專輯《The Dark Side of the Moon》發行 50 週年。這張廣受讚譽的專輯最初於 1973 年發行，超越了音樂範疇，成為世世代代聽眾的文化試金石。《Money》和《Time》等曲目已成為永恆的頌歌，傳遞出一種模糊了現實與迷幻想像界限的聲音體驗。此 50 週年紀念版採用精美的摺頁封套包裝，並附有值得收藏的海報和貼紙，提升了資深粉絲和新聽眾的整體體驗。《The Dark Side of the Moon》仍然是一趟穿越人類經驗、社會反思和存在主義思考主題的宇宙之旅，鞏固了其作為有史以來最偉大專輯之一的地位。此重製版本確保專輯的音質比以往任何時候都更好，讓您完全沉浸在其深邃的意境中。",
      },
      {
        title: "AM [180-gram]",
    ...
    Punk: [
      ...
      },
      {
        ...
        description_zh:
          "為了慶祝 Fueled By Ramen 成立 25 週年，Paramore 的《Riot!》以令人驚嘆的銀色黑膠唱片重新發行，慶祝流行龐克歷史上的一個里程碑。這張專輯最初於 2007 年發行，充滿了包括爆炸性熱門歌曲《Misery Business》和《That's What You Get》在內的高能量曲目。由 David Bendeth 製作，捕捉了樂團充滿活力和叛逆的精神，將《Riot!》推向好評，並奠定了其作為流派定義之作的地位。",
      },
      {
        ...
        description:
          "'The Black Parade' is the third album by My Chemical Romance. This album is often considered an epic rock opera, detailing the saga of a terminal cancer patient. It is theatrical and ambitious with soaring anthems and emotional ballads, capturing the band's punk rock energy and emo sensibilities. Released in 2006, this album features the iconic title track and \"Teenagers\".",
        description_zh:
          "《The Black Parade》是 My Chemical Romance 的第三張專輯。這張專輯通常被認為是一部史詩般的搖滾歌劇，詳細講述了一位絕症患者的傳奇故事。它具有戲劇性和野心，擁有高亢的頌歌和情感豐富的抒情曲，捕捉了樂團的龐克搖滾能量和情緒化感性。這張 2006 年發行的專輯收錄了標誌性的同名主打歌和《Teenagers》。",
      },
      {
        title: "Nevermind",
        artist: "Nirvana",
        ...
        description_zh:
          "用 Nirvana 的開創性專輯《Nevermind》重回油漬搖滾的關鍵時代，現已推出黑膠版本。這張 1991 年的發行將這來自西雅圖的三人組推向了聚光燈下，將他們的聲音深深烙印為 X 世代的頌歌，並將另類搖滾推向主流。收錄了爆炸性的曲目《Smells Like Teen Spirit》和深刻內省的《Something in the Way》，《Nevermind》捕捉了定義一個世代的原始情感和未經過濾的焦慮。",
      },
      {
      ...
      },
      {
        ...
        description:
          "Toxicity is the second studio album by heavy metal band System of a Down, released on September 4, 2001. Featuring the heaviness and aggression of System of a Down's debut studio album, Toxicity features more melody, harmonies, and singing than the band's aforementioned album. Primary writer Daron Malakian cited The Beatles as a major influence on Toxicity. Critical reception was positive; it received perfect scores from AllMusic and Kerrang!.",
        description_zh:
          "《Toxicity》是重金屬樂團 System of a Down 的第二張錄音室專輯，發行於 2001 年 9 月 4 日。它繼承了 System of a Down 首張錄音室專輯的沉重和侵略性，但比前作擁有更多的旋律、和聲及歌唱。主要創作者 Daron Malakian 指出 The Beatles 是《Toxicity》的主要影響來源。樂評反應積極，獲得了 AllMusic 和 Kerrang! 的滿分評價。",
      },
      {
        ...
        description_zh:
          "用《White Pony》體驗 Deftones 開創性的藝術性，這張廣受好評的專輯現已推出雙黑膠唱片。於 2000 年發行，這張專輯標誌著樂團聲音的重大演變，將另類金屬與瞪鞋搖滾、新浪潮和 Trip-hop 元素融合在一起。收錄了《Change (In the House of Flies)》和《Digital Bath》等標誌性曲目，《White Pony》展現了 Chino Moreno 空靈的嗓音和樂團的動態範圍。",
      },
      {
        title: "Jar Of Flies",
        artist: "Alice in Chains",
        ...
        description_zh:
          "黑暗、憂鬱且絕美，《Jar of Flies》展現了 Alice in Chains 最內省的一面。這張 1994 年的 EP 將原聲吉他的憂鬱與油漬搖滾的強烈情感融合在一起，傳遞出一種既原始又精緻的聲音。收錄了《No Excuses》、《Nutshell》和《I Stay Away》等傑出曲目，這張 EP 標誌著樂團背離其更重型根源的大膽轉變。它層次分明，充滿情感深度、和聲演唱以及藍調風格的原聲編曲。",
      },
    ],
    Blues: [
      {
        ...
        description_zh:
          "在其漫長的職業生涯中，The Grateful Dead 受到了從藍調、鄉村、搖滾到民謠等各種美國音樂藝術家和傳統的啟發——這是有史以來最令人興奮和感動的音樂之一。這裡收錄了 The Dead 最受喜愛的翻唱曲目的原始版本，其音樂深度、原創性和情感令人驚喜和愉悅。這個合集由一群 Dead 學者和愛好者精心編製。",
      },
      {
      ...
      },
      {
        ...
        description:
          "Sound & Color is the second studio album by American rock band Alabama Shakes. Released in April 2015 via ATO Records, the album debuted at number one on the US Billboard 200 albums chart. It was nominated for six Grammy Awards, including Album of the Year, and won four, including Best Alternative Music Album.",
        description_zh:
          "《Sound & Color》是美國搖滾樂團 Alabama Shakes 的第二張錄音室專輯。該專輯於 2015 年 4 月透過 ATO Records 發行，首週即登上美國告示牌 200 強專輯榜冠軍。它獲得了六項葛萊美獎提名，包括年度專輯，並贏得了其中四項，包括最佳另類音樂專輯。",
      },
      {
        title: "Astral Weeks (180-gram)",
        artist: "Van Morrison",
        ...
        img: "https://cdn.shopify.com/s/files/1/0704/2026/7313/files/8335046869297_85quality_Van_Morrison_-_Astral_Weeks.webp?v=1734326361",
        description:
          "Astral Weeks is the second studio album by Northern Irish singer-songwriter Van Morrison. It was recorded at Century Sound Studios in New York City during September and October 1968, and released in November of that year by Warner Bros. Records.",
        description_zh:
          "《Astral Weeks》是北愛爾蘭創作歌手 Van Morrison 的第二張錄音室專輯。於 1968 年 9 月和 10 月在紐約市 Century Sound Studios 錄製，並於同年 11 月由華納兄弟唱片發行。",
      },
      {
        ...
        description:
          "Bridge of Sighs is the second solo album by the English guitarist and songwriter Robin Trower. Released in 1974, it is his most commercially successful album, reaching number 7 on the Billboard 200 chart.",
        description_zh:
          "《Bridge of Sighs》是英國吉他手兼詞曲作者 Robin Trower 的第二張個人專輯。發行於 1974 年，這是他商業上最成功的專輯，在告示牌 200 強榜單上達到第 7 名。",
      },
    ],
  };
  ...
  const renderProducts = (category) => {
    ...
    products.forEach((product, index) => {
      ...
      if (product.originalPrice) {
        ...
        priceHtml = `
              <span class="product-price original-price" data-base-price="${originalBase}">${formatPrice(
          originalBase,
          currentCurrency
        )}</span>
              <span class="product-price sale-price" data-base-price="${basePrice}">${formatPrice(
          basePrice,
          currentCurrency
        )}</span>
          `;
      } else {
        priceHtml = `<span class="product-price" data-base-price="${basePrice}">${formatPrice(
          basePrice,
          currentCurrency
        )}</span>`;
      }
  ...
  const setupCarouselInteractivity = () => {
    ...
    carouselCards.forEach((card) => {
      ...
      let product = allProducts.find((p) => {
        ...
        return (
          pTitle === cardTitle ||
          pTitle.includes(cardTitle) ||
          cardTitle.includes(pTitle)
        );
      });
      ...
      if (!product) {
        console.warn(
          `Product not found in data: ${title}. Using DOM fallback.`
        );
        ...
        const priceBase = priceDisplay
          ? priceDisplay.getAttribute("data-base-price")
          : "0";
  ...
  const renderModalDescription = (description, description_zh) => {
    ...
    const defaultDesc =
      "Experience the uncompressed, raw emotion of analog sound. This piece has been carefully verified for quality and authenticity.";
  ...
  if (categoryParam && typeof categoryCards !== "undefined") {
    ...
    const targetCard = document.querySelector(
      `.category-card[data-category="${categoryParam}"]`
    );
    if (targetCard) {
      setTimeout(() => {
        targetCard.click();
  ...
  const updateCartTotals = () => {
    ...
    if (subtotalEl)
      subtotalEl.innerText = formatPrice(subtotal, currentCurrency);
    if (shippingEl)
      shippingEl.innerText =
        currentShippingCost === 0
          ? "Free"
          : formatPrice(currentShippingCost, currentCurrency);
  ...
  window.renderCart = () => {
    ...
    items.forEach((item, index) => {
      ...
      div.innerHTML = `
            ...
            <div style="display:flex; align-items:center;">
                <div class="cart-item-price" data-base-price="${
                  item.price
                }">${formatPrice(item.price, currentCurrency)}</div>
  ...
  const updateAuthUI = () => {
    ...
    if (userStr) {
      ...
      authContainer.innerHTML = `
               <a href="${loginPath}" class="auth-icon">${t.auth_login}</a>
           `;
    }
  };
